...
/**
 * WORKERS — live boss-triggered ephemeral Slack workers (the Phase-1 spawn loop):
...
const sectionHead: React.CSSProperties = {
  fontFamily: 'var(--cth-font-ui)', fontWeight: 700, fontSize: 10.5, lineHeight: '12px', textTransform: 'uppercase',
  letterSpacing: '0.06em', color: 'var(--cth-ink-500)', margin: '2px 0'
};
...
export function WorkersTab() {
  ...
  return (
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', gap: 14, padding: 10, overflow: 'auto', background: 'var(--cth-paper-200)' }}>
      <div>
        ...
        <p style={{ fontFamily: 'var(--cth-font-ui)', fontSize: 11, color: 'var(--cth-ink-700)', margin: '2px 0 8px' }}>
          Short-lived agents Rudy spins up for one job (a Slack message, a spawn request), each in its own git worktree. They run to completion, report back, then tear down.
        </p>
