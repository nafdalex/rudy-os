...
```sh
codesign --verify --deep --strict --verbose=2 "dist/mac-universal/Rudy OS.app"
spctl --assess --type execute --verbose "dist/mac-universal/Rudy OS.app"   # → "accepted, source=Notarized Developer ID"
xcrun stapler validate "dist/mac-universal/Rudy OS.app"
```
