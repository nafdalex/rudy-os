      ...
      {!open ? (
        <button
          ...
          style={{
            ...
            background: active ? 'var(--cth-sky-light)' : 'var(--cth-cream-200)',
            boxShadow: `inset 0 0 0 1px ${active ? 'var(--cth-sky)' : 'var(--cth-ink-500)'}`,
        ...
        <PixelPanel variant="dialog" title="HIVE MEMORY" noPadding>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, padding: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
              ...
              {status?.available && (
                <PixelToggle on={!!status.enabled} onClick={toggleEnabled} />
              )}
            </div>
            ...
            {!status?.available && (
              <div style={{
                ...
                {/* The commands used to be inlined here, hardcoded for macOS
                    ...
                    dependency, the live detected state, and the delegate-to-Rudy
