...
## 本地覆盖规则（Rudy OS blog — local overrides）

These project-level overrides apply on top of everything above whenever this skill runs in this repo:

1. **小黑是黄色的。** Xiaohei's body is ALWAYS filled with the Rudy OS accent yellow **#FFCA54** with a thin black hand-drawn outline (no suit, no tie). Eyes become two small BLACK dots (white dots don't read on yellow). Keep the bean shape, thin legs, blank expression — every image, no exceptions.
