...
/** A preset that seeds an IntegrationRecord. Extend the catalog by appending
...
export function validateIntegrationRecord(
  ...
  if (!INTEGRATION_SLUG_RE.test(id)) {
    return { ok: false, error: 'id must be a lowercase slug (2 to 40 chars, a to z 0 to 9 -, no leading/trailing hyphen)' };
  }
...
/** v1 reference templates — the two end-to-end references. Append more here. */
