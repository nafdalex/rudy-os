#!/usr/bin/env node
/**
 * rudy-slack-reply.cjs — post a message back into the Slack thread that triggered
 ...
 *
 * Usage:
 *   node rudy-slack-reply.cjs --channel C123 --thread 1700000000.000100 --text "..."
...
function fail(msg) {
  process.stderr.write(`rudy-slack-reply: ${msg}\n`);
  process.exit(1);
}
