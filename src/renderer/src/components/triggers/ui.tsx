...
export function Toggle({ on, onClick }: {
  ...
  // The one switch look, shared with Settings (components/PixelToggle).
  return <PixelToggle on={on} onClick={onClick} />;
}
    ...
    <div style={{ marginBottom: 8, background: 'var(--cth-paper-100)', boxShadow: 'inset 0 0 0 1px var(--cth-ink-100)' }}>
      ...
      >
        ...
        <span style={{ flex: 1, minWidth: 0 }}>
          <span style={{
            display: 'block', fontFamily: 'var(--cth-font-ui)', fontWeight: 700, fontSize: 10.5, lineHeight: '13px',
