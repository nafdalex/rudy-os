/**
 * TRIGGERS — every way the Boss orchestrator gets woken up without a human typing.
 *
 ...
 * Rudy OS; setting an org key lets their instance address yours.
 *
...
export const CLONE_NODE_BLURB =
  'Set an organisation key and your teammates can message your Rudy, the copy of '
  + 'Rudy OS running on your machine. Each teammate runs their own, so an org key '
